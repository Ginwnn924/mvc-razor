...
-- DATA PRODUCTS
-- Category mapping: 1=Đồ uống, 2=Bánh kẹo, 3=Gia vị, 4=Đồ gia dụng, 5=Mỹ phẩm
INSERT INTO products (category_id,supplier_id,product_name,barcode,price,unit) VALUES
-- Đồ uống (category_id = 1)
(1, 1, 'Coca Cola lon', '8900000000001', 314838, 'hộp'),(1, 3, 'Pepsi lon', '8900000000002', 114807, 'cái'),(1, 3, 'Trà Xanh 0 độ', '8900000000003', 415725, 'tuýp'),(1, 1, 'Sting dâu', '8900000000004', 351670, 'cái'),(1, 2, 'Red Bull', '8900000000005', 402179, 'lon'),(1, 1, 'Cà phê G7', '8900000000026', 201228, 'lon'),(1, 1, 'Trà Lipton', '8900000000027', 38039, 'cái'),(1, 3, 'Sữa Vinamilk', '8900000000028', 252845, 'chai'),(1, 1, 'Sữa TH True Milk', '8900000000029', 35278, 'hộp'),(1, 2, 'Nước suối Lavie', '8900000000030', 331637, 'lon'),(1, 1, 'Nước ngọt Sprite', '8900000000046', 230083, 'hộp'),(1, 3, 'Trà sữa đóng chai', '8900000000047', 15130, 'cái'),
-- Bánh kẹo (category_id = 2)
(2, 2, 'Bánh Oreo', '8900000000006', 209283, 'chai'),(2, 3, 'Bánh Chocopie', '8900000000007', 212528, 'lon'),(2, 2, 'Kẹo Alpenliebe', '8900000000008', 34313, 'lon'),(2, 1, 'Kẹo bạc hà', '8900000000009', 316289, 'cái'),(2, 2, 'Socola KitKat', '8900000000010', 139959, 'chai'),(2, 1, 'Bánh mì sandwich', '8900000000041', 279350, 'cái'),(2, 2, 'Mì gói Hảo Hảo', '8900000000042', 9413, 'hộp'),(2, 2, 'Mì Omachi', '8900000000043', 26616, 'hộp'),(2, 2, 'Bún khô', '8900000000044', 350911, 'gói'),(2, 1, 'Phở ăn liền', '8900000000045', 407779, 'tuýp'),(2, 3, 'Snack Oishi', '8900000000048', 43415, 'cái'),(2, 2, 'Snack Lay's', '8900000000049', 83536, 'tuýp'),(2, 2, 'Kẹo dẻo Haribo', '8900000000050', 328680, 'cái'),
-- Gia vị (category_id = 3)
(3, 1, 'Nước mắm Nam Ngư', '8900000000011', 51792, 'chai'),(3, 2, 'Nước tương Maggi', '8900000000012', 462539, 'lon'),(3, 3, 'Muối i-ốt', '8900000000013', 173302, 'cái'),(3, 1, 'Bột ngọt Ajinomoto', '8900000000014', 443069, 'cái'),(3, 2, 'Dầu ăn Tường An', '8900000000015', 281354, 'tuýp'),
-- Đồ gia dụng (category_id = 4)
(4, 1, 'Nồi cơm điện', '8900000000016', 405347, 'hộp'),(4, 3, 'Ấm siêu tốc', '8900000000017', 113087, 'chai'),(4, 2, 'Quạt máy', '8900000000018', 69968, 'hộp'),(4, 1, 'Bếp gas mini', '8900000000019', 416845, 'lon'),(4, 3, 'Máy xay sinh tố', '8900000000020', 334564, 'hộp'),(4, 3, 'Giấy vệ sinh Pulppy', '8900000000032', 495429, 'chai'),(4, 2, 'Bình nước Lock&Lock', '8900000000033', 354771, 'gói'),(4, 1, 'Hộp nhựa Tupperware', '8900000000034', 297415, 'cái'),(4, 3, 'Dao Inox', '8900000000035', 47523, 'hộp'),(4, 1, 'Bàn chải Colgate', '8900000000036', 136417, 'chai'),(4, 2, 'Kem đánh răng P/S', '8900000000037', 93713, 'hộp'),(4, 3, 'Nước súc miệng Listerine', '8900000000038', 223906, 'gói'),(4, 1, 'Khẩu trang 3M', '8900000000040', 464252, 'gói'),
-- Mỹ phẩm (category_id = 5)
(5, 1, 'Sữa rửa mặt Hazeline', '8900000000021', 188475, 'lon'),(5, 1, 'Kem dưỡng da Pond's', '8900000000022', 413840, 'hộp'),(5, 3, 'Dầu gội Sunsilk', '8900000000023', 158950, 'tuýp'),(5, 2, 'Sữa tắm Dove', '8900000000024', 336928, 'chai'),(5, 1, 'Nước hoa Romano', '8900000000025', 352508, 'cái'),(5, 3, 'Khăn giấy Tempo', '8900000000031', 102525, 'chai'),(5, 2, 'Bông tẩy trang', '8900000000039', 317819, 'tuýp');
...
-- DATA REVIEWS - Tạo đánh giá mẫu cho các sản phẩm
INSERT INTO reviews (product_id, customer_id, rating, comment) VALUES
-- Reviews cho sản phẩm 1 (Coca Cola lon)
(1, 1, 5, 'Nước ngọt rất ngon, đóng gói đẹp. Sẽ mua lại!'),
(1, 2, 4, 'Chất lượng tốt, giá hợp lý.'),
(1, 3, 5, 'Sản phẩm yêu thích của tôi, luôn có trong tủ lạnh.'),
(1, 4, 4, 'Ngon nhưng hơi ngọt một chút.'),
(1, 5, 5, 'Rất hài lòng với sản phẩm này.'),

-- Reviews cho sản phẩm 2 (Pepsi lon)
(2, 6, 4, 'Pepsi ngon, giá tốt.'),
(2, 7, 5, 'Sản phẩm chất lượng, đóng gói cẩn thận.'),
(2, 8, 4, 'Ngon nhưng vẫn thích Coca hơn.'),
(2, 9, 5, 'Rất hài lòng!'),

-- Reviews cho sản phẩm 3 (Trà Xanh 0 độ)
(3, 10, 5, 'Trà xanh thơm ngon, giải khát tốt.'),
(3, 11, 4, 'Chất lượng ổn, giá hợp lý.'),
(3, 12, 5, 'Sản phẩm tốt cho sức khỏe.'),
(3, 13, 4, 'Ngon nhưng hơi nhạt.'),
(3, 14, 5, 'Rất thích vị trà xanh này.'),

-- Reviews cho sản phẩm 4 (Sting dâu)
(4, 15, 5, 'Sting dâu rất ngon, vị dâu đậm đà.'),
(4, 16, 4, 'Ngon nhưng hơi ngọt.'),
(4, 17, 5, 'Sản phẩm yêu thích của con tôi.'),
(4, 18, 4, 'Chất lượng tốt.'),

-- Reviews cho sản phẩm 5 (Red Bull)
(5, 19, 5, 'Red Bull giúp tăng năng lượng hiệu quả.'),
(5, 20, 4, 'Ngon nhưng giá hơi cao.'),
(5, 1, 5, 'Rất tốt khi làm việc khuya.'),
(5, 2, 4, 'Chất lượng ổn.'),

-- Reviews cho sản phẩm 6 (Bánh Oreo)
(6, 3, 5, 'Bánh Oreo giòn ngon, vị socola đậm đà.'),
(6, 4, 5, 'Sản phẩm yêu thích của cả nhà.'),
(6, 5, 4, 'Ngon nhưng hơi ngọt.'),
(6, 6, 5, 'Rất hài lòng với chất lượng.'),

-- Reviews cho sản phẩm 7 (Bánh Chocopie)
(7, 7, 4, 'Bánh ngon, giá hợp lý.'),
(7, 8, 5, 'Vị socola thơm ngon.'),
(7, 9, 4, 'Chất lượng ổn.'),

-- Reviews cho sản phẩm 8 (Kẹo Alpenliebe)
(8, 10, 5, 'Kẹo thơm ngon, nhiều vị.'),
(8, 11, 4, 'Ngon nhưng hơi ngọt.'),
(8, 12, 5, 'Con tôi rất thích.'),

-- Reviews cho sản phẩm 9 (Kẹo bạc hà)
(9, 13, 4, 'Kẹo bạc hà mát lạnh, thơm.'),
(9, 14, 5, 'Rất thích vị bạc hà này.'),
(9, 15, 4, 'Chất lượng tốt.'),

-- Reviews cho sản phẩm 10 (Socola KitKat)
(10, 16, 5, 'Socola KitKat giòn ngon, vị đậm đà.'),
(10, 17, 5, 'Sản phẩm yêu thích.'),
(10, 18, 4, 'Ngon nhưng giá hơi cao.'),
(10, 19, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 11 (Nước mắm Nam Ngư)
(11, 20, 5, 'Nước mắm đậm đà, chất lượng tốt.'),
(11, 1, 4, 'Ngon nhưng hơi mặn.'),
(11, 2, 5, 'Sản phẩm truyền thống chất lượng.'),

-- Reviews cho sản phẩm 12 (Nước tương Maggi)
(12, 3, 5, 'Nước tương Maggi thơm ngon.'),
(12, 4, 4, 'Chất lượng ổn, giá hợp lý.'),
(12, 5, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 13 (Muối i-ốt)
(13, 6, 4, 'Muối i-ốt tốt cho sức khỏe.'),
(13, 7, 5, 'Chất lượng tốt.'),
(13, 8, 4, 'Giá hợp lý.'),

-- Reviews cho sản phẩm 14 (Bột ngọt Ajinomoto)
(14, 9, 5, 'Bột ngọt Ajinomoto chất lượng.'),
(14, 10, 4, 'Ngon, dùng lâu rồi.'),
(14, 11, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 15 (Dầu ăn Tường An)
(15, 12, 5, 'Dầu ăn Tường An chất lượng tốt.'),
(15, 13, 4, 'Ngon, giá hợp lý.'),
(15, 14, 5, 'Sản phẩm tin dùng.'),

-- Reviews cho sản phẩm 16 (Nồi cơm điện)
(16, 15, 5, 'Nồi cơm điện nấu cơm ngon, tiện lợi.'),
(16, 16, 4, 'Chất lượng tốt, giá hợp lý.'),
(16, 17, 5, 'Rất hài lòng với sản phẩm.'),
(16, 18, 4, 'Nấu cơm ngon nhưng hơi lâu.'),

-- Reviews cho sản phẩm 17 (Ấm siêu tốc)
(17, 19, 5, 'Ấm siêu tốc đun nước nhanh, tiện lợi.'),
(17, 20, 4, 'Chất lượng ổn.'),
(17, 1, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 18 (Quạt máy)
(18, 2, 4, 'Quạt máy mát, giá hợp lý.'),
(18, 3, 5, 'Chất lượng tốt, mát lạnh.'),
(18, 4, 4, 'Ngon nhưng hơi ồn.'),

-- Reviews cho sản phẩm 19 (Bếp gas mini)
(19, 5, 5, 'Bếp gas mini tiện lợi, an toàn.'),
(19, 6, 4, 'Chất lượng tốt.'),
(19, 7, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 20 (Máy xay sinh tố)
(20, 8, 5, 'Máy xay sinh tố mạnh, xay nhuyễn.'),
(20, 9, 4, 'Chất lượng tốt, giá hợp lý.'),
(20, 10, 5, 'Rất hài lòng với sản phẩm.'),
(20, 11, 4, 'Xay ngon nhưng hơi ồn.'),

-- Reviews cho sản phẩm 21 (Sữa rửa mặt Hazeline)
(21, 12, 5, 'Sữa rửa mặt Hazeline làm sạch tốt, da mịn.'),
(21, 13, 4, 'Chất lượng ổn.'),
(21, 14, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 22 (Kem dưỡng da Pond's)
(22, 15, 5, 'Kem dưỡng da Pond's dưỡng ẩm tốt.'),
(22, 16, 4, 'Chất lượng tốt, giá hợp lý.'),
(22, 17, 5, 'Da mịn màng sau khi dùng.'),

-- Reviews cho sản phẩm 23 (Dầu gội Sunsilk)
(23, 18, 5, 'Dầu gội Sunsilk làm sạch tốt, tóc mềm mượt.'),
(23, 19, 4, 'Chất lượng ổn.'),
(23, 20, 5, 'Rất hài lòng.'),
(23, 1, 4, 'Ngon nhưng hơi khô tóc.'),

-- Reviews cho sản phẩm 24 (Sữa tắm Dove)
(24, 2, 5, 'Sữa tắm Dove dưỡng ẩm tốt, da mịn.'),
(24, 3, 4, 'Chất lượng tốt.'),
(24, 4, 5, 'Rất hài lòng.'),

-- Reviews cho sản phẩm 25 (Nước hoa Romano)
(25, 5, 5, 'Nước hoa Romano thơm lâu, mùi dễ chịu.'),
(25, 6, 4, 'Chất lượng tốt, giá hợp lý.'),
(25, 7, 5, 'Rất thích mùi hương này.'),

-- Reviews cho sản phẩm 26 (Cà phê G7)
(26, 8, 5, 'Cà phê G7 thơm ngon, đậm đà.'),
(26, 9, 4, 'Chất lượng tốt.'),
(26, 10, 5, 'Sản phẩm yêu thích mỗi sáng.'),

-- Reviews cho sản phẩm 27 (Trà Lipton)
(27, 11, 4, 'Trà Lipton thơm, giá hợp lý.'),
(27, 12, 5, 'Rất hài lòng.'),
(27, 13, 4, 'Chất lượng ổn.'),

-- Reviews cho sản phẩm 28 (Sữa Vinamilk)
(28, 14, 5, 'Sữa Vinamilk thơm ngon, bổ dưỡng.'),
(28, 15, 4, 'Chất lượng tốt.'),
(28, 16, 5, 'Con tôi rất thích.'),

-- Reviews cho sản phẩm 29 (Sữa TH True Milk)
(29, 17, 5, 'Sữa TH True Milk chất lượng tốt.'),
(29, 18, 4, 'Ngon, giá hợp lý.'),
(29, 19, 5, 'Rất hài lòng.'),
